...
export default function CourseCard({ data }) {
  ...
  return (
    <div 
      className="w-[22rem]  h-[445px]  shadow-custom  rounded-lg cursor-pointer group overflow-hidden bg-white transition-transform transform hover:scale-[1.01]"
    ...
    >
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-2 right-2 p-2 bg-white rounded-full">
          <FaPlay className="text-sky-400 text-xl" />
        </div>
      </div>
